...
<body>
    <div class="container">
        <div class="header">
            <h1>Paiement reçu et sécurisé !</h1>
        </div>
        <div class="content">
            <p>Bonjour,</p>
            <p>Nous vous confirmons que votre paiement pour la mission suivante a été reçu avec succès et est maintenant sécurisé dans notre système d'entiercement (escrow).</p>
            ...
            <div class="info-card">
                ...
                <p style="margin: 4px 0 0; color: #334155;">Prestataire : {{ $providerName }}</p>
            </div>
            ...
            <div class="details">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value" style="color: #3b82f6;">Sécurisé en Escrow</span>
                </div>
            </div>

            <p style="margin-top: 32px;">Les fonds seront libérés au prestataire une fois que vous aurez validé la mission.</p>
            <div style="text-align: center;">
                <a href="{{ config('app.url') }}" class="btn">Suivre ma mission</a>
            </div>
        </div>
        <div class="footer">
